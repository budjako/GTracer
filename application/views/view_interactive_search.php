<!-- 
	Interactive page functionality 
-->
...
<div id="content-box" class="content-box clearfix">
	<div class="inner-content">
		...
		<div id="change_here_table"></div>			<!-- table view of results are shown here -->
		<div id="change_here_chart"></div>			<!-- pie or bar chart view of results are shown here -->
		<div id="change_here_map"></div>			<!-- map view of results are shown here -->
		<center>
			<form name="interactivesearch" id="interactivesearch">
				...
				<div id="querychoices">				<!-- selection of view type of results -->
					...
					<div id="chartspecs"></div>		<!-- shows options when view type is chart -->
					<div id="mapspecs"></div>		<!-- shows options when view type is map -->
				</div>
			</form>
		</center>
		<div class="dragdrop">
			<fieldset class="fields">				<!-- contains the fields that can be specified-->
				...
				<fieldset class="fieldcont">
					...
					<div class="floatright"><input type="checkbox" id="current_job"></input><label for="current_job">Current job only?</label></div>
				</fieldset>
				<fieldset class="fieldcont">
			...
			<fieldset class="query ui-droppable">			<!-- droppable area where the draggable fields can be placed -->
				<legend>Query</legend>
			</fieldset>
		</div>
	</div>
